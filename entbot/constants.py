...
CHOICE_MODE_PROMPT = """Choisis un des services ci-dessous en entrant le numéro correspondant :\n
1 : Télécharge tous tes cours disponibles sur ametice
2 : Récupère le lien de l'emploi du temps de ton choix\n"""
